import pyLightspeedRetail.api
import pyLightspeedRetail.customer_login_token
import os
...
api = pyLightspeedRetail.api.pyLightspeedRetailApi(client_id='id', store_hash='hash', access_token='token')
...
login_token = pyLightspeedRetail.customer_login_token.create(api, customer.id)
...
login_token_url = pyLightspeedRetail.customer_login_token.create_url(api, customer.id, use_bc_time=True)
